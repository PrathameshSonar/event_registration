...
// Fallback chain (so it's correct during AND after the JSONB migration):
//   1. translations[lang][field]         — the new JSONB model
//   2. row[`${field}_${lang}`]           — the legacy per-column model (e.g. title_hi)
