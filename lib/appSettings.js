...
// ── About Us page (Pitham + Guruji sections) ─────────────────────────────────
// Two rich, admin-editable sections on /about — one about the Pitham/temple, one
// about Guruji. Each has a per-language heading + body and one image. Empty
// sections simply don't render.
export const DEFAULT_ABOUT_PAGE = {
    pitham: { title: { en: '', hi: '', mr: '' }, body: { en: '', hi: '', mr: '' }, image_url: '' },
    guruji: { title: { en: '', hi: '', mr: '' }, body: { en: '', hi: '', mr: '' }, image_url: '' },
};
...
export const SETTINGS = {
    ...
    about_page: {
        ...
        sanitize(v = {}) {
            ...
            return { pitham: section(v.pitham), guruji: section(v.guruji) };
        },
    },
    seo: {
