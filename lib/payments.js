...
export async function sendPaymentLink(reg, kind = 'balance') {
    ...
    const lead = isEnquiry
        ? `Thank you for your interest in <strong>${categoryTitle}</strong>. To confirm your registration and receive your entry pass, please complete the payment:`
        : `Thank you — your advance of <strong>₹${Number(reg.amount_paid).toLocaleString('en-IN')}</strong> for <strong>${categoryTitle}</strong> is received. To confirm your registration and receive your entry pass, please clear the remaining balance:`;
