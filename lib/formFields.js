...
export const BUILTIN_FIELDS = [
    ...
    // 'problem' / Samasya was retired as a built-in — add it as a CUSTOM field if a
    // tier needs it. The `registrations.problem_samasya` column is kept so existing
    // records still read; new registrations simply leave it null.
];
