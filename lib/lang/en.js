...
const en = {
  ...
  // Spelled out because the advance is a % of the SEVA FEE only — the donation is
  // never part of it, and a user who isn't told that finds it out at the balance.
  form_sum_donation_in_balance: (amount, pct) =>
    `Note: your ₹${amount} donation is not part of this advance — the advance is ${pct}% of the Seva fee only. The full donation is collected later, with the balance.`,
  form_sum_balance_split: (seva, donation) =>
    `Balance = Seva ₹${seva} + Donation ₹${donation}`,
