...
export const EMAIL_TEMPLATES = {
    ticket: {
        ...
        vars: ['siteName', 'name', 'tier', 'attendees', 'total', 'paymentRef', 'eventDate', 'eventVenue'],
        wrap: false,
        subject: '✅ Confirmed: Your Ticket for {{siteName}}',
  ...
  <div style="background-color: #171717; padding: 32px; text-align: center;">
    ...
    <h1 style="color: #ffffff; margin: 8px 0 0 0; font-size: 28px; font-weight: 800;">{{siteName}}</h1>
  </div>
  <div style="padding: 32px; background-color: #ffffff;">
    ...
    qr: {
        ...
        vars: ['siteName', 'name', 'tier', 'attendees', 'total', 'qrImage', 'passUrl', 'shortId'],
        wrap: false,
        subject: '🎟️ Your Entry QR Code — {{siteName}} Mahotsav',
        html: `<div style="font-family:sans-serif;max-width:600px;margin:0 auto;border:1px solid #e5e7eb;border-radius:16px;overflow:hidden;">
  <div style="background:#171717;padding:32px;text-align:center;">
    ...
    <h1 style="color:#fff;margin:8px 0 0;font-size:26px;font-weight:800;">{{siteName}} Mahotsav</h1>
  </div>
  ...
  <div style="background:#f3f4f6;padding:16px;text-align:center;font-size:11px;color:#9ca3af;border-top:1px solid #e5e7eb;">
    ...
    balance_link: {
        ...
        vars: ['siteName', 'name', 'tier', 'amount', 'advancePaid', 'payLink'],
        wrap: true,
        subject: '⏳ Pay your balance — {{siteName}} registration',
...
<p style="font-size:12px;color:#9ca3af;">Your entry pass is issued only after the full amount is paid. This is a No-Refund registration.</p>`,
    ...
    balance_reminder: {
        ...
        vars: ['siteName', 'name', 'tier', 'amount', 'payLink'],
        wrap: true,
        subject: '⏳ Reminder: pay your balance — {{siteName}}',
        html: `<p style="font-size:16px;color:#404040;margin-top:0;">Namaste <strong>{{name}}</strong>,</p>
...
<p style="font-size:12px;color:#9ca3af;">Your entry pass is issued only after full payment. No-refund policy applies.</p>`,
    ...
    payment_link: {
        ...
        vars: ['siteName', 'name', 'tier', 'amount', 'payLink'],
        wrap: true,
        subject: '🙏 Complete your registration — {{siteName}}',
        html: `<p style="font-size:16px;color:#404040;margin-top:0;">Namaste <strong>{{name}}</strong>,</p>
...
<p style="font-size:12px;color:#9ca3af;">Your entry pass is issued only after the full amount is paid. This is a No-Refund registration.</p>`,
    ...
    cancellation: {
        ...
        vars: ['siteName', 'name', 'tier', 'reason', 'hadPaid', 'refundPolicyUrl'],
        wrap: true,
        subject: 'Your registration has been cancelled — {{tier}} ({{siteName}})',
        html: `<p style="font-size:16px;color:#404040;margin-top:0;">Namaste <strong>{{name}}</strong>,</p>
...
<p style="font-size:14px;color:#6b7280;line-height:1.6;">If you believe this is a mistake, please reply to this email or contact us.</p>`,
    ...
    offline_submitted: {
        ...
        vars: ['siteName', 'name', 'tier', 'method', 'reference'],
        wrap: true,
        subject: '⏳ Payment received — under verification ({{siteName}})',
        html: `<p style="font-size:16px;color:#404040;margin-top:0;">Namaste <strong>{{name}}</strong>,</p>
<p style="font-size:14px;color:#6b7280;line-height:1.6;">We've received your <strong>{{method}}</strong> payment details for <strong>{{tier}}</strong>{{#if reference}} (Ref: {{reference}}){{/if}}. Our team will verify it and confirm your registration shortly. Your entry pass is issued once the payment is verified.</p>`,
    ...
    offline_rejected: {
        ...
        vars: ['siteName', 'name', 'tier', 'reason', 'siteUrl'],
        wrap: true,
        subject: '⚠️ Action needed: payment could not be verified ({{siteName}})',
        html: `<p style="font-size:16px;color:#404040;margin-top:0;">Namaste <strong>{{name}}</strong>,</p>
...
<p style="font-size:14px;color:#6b7280;line-height:1.6;">Please re-submit the correct payment details{{#if siteUrl}} at <a href="{{siteUrl}}" style="color:#ea580c;">{{siteUrl}}</a>{{/if}} or reply to this email.</p>`,
    ...
    waitlist: {
        ...
        vars: ['siteName', 'name', 'tier', 'registerLink'],
        wrap: true,
...
<p style="font-size:12px;color:#9ca3af;">This spot is first-come — the link may stop working once seats fill.</p>`,
    ...
    feedback: {
        ...
        vars: ['siteName', 'name', 'feedbackLink'],
        wrap: true,
        subject: '🙏 Thank you for joining the {{siteName}} Mahotsav',
        html: `<p style="font-size:16px;color:#404040;margin-top:0;">Namaste <strong>{{name}}</strong>,</p>
<p style="font-size:14px;color:#6b7280;line-height:1.6;">Thank you for being part of the {{siteName}} Mahotsav — your presence made it special. 🙏</p>
...
<p><a href="{{feedbackLink}}" style="display:inline-block;background:#ea580c;color:#fff;font-weight:700;padding:12px 24px;border-radius:8px;text-decoration:none;">Share your feedback</a></p>`,
    ...
    donation_receipt: {
        ...
        vars: ['siteName', 'name', 'amount', 'paymentRef'],
        wrap: true,
        subject: '🙏 Thank you for your Seva — {{siteName}}',
        html: `<p style="font-size:16px;color:#404040;margin-top:0;">Namaste <strong>{{name}}</strong>,</p>
<p style="font-size:14px;color:#6b7280;line-height:1.6;">Thank you for your generous contribution of <strong>₹{{amount}}</strong> towards the {{siteName}} Mahotsav. Your Seva sustains this sacred gathering.</p>
