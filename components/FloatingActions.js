    ...
    <>
      ...
      {wa && (
        <a
          ...
          className="fixed z-40 bottom-24 md:bottom-6 right-4 md:right-6 flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white font-semibold pl-3 pr-4 py-3 rounded-full shadow-xl transition group"
        >
      ...
      {hasCategories && registrationOpen && (
        <div className="fixed z-40 bottom-0 inset-x-0 md:hidden bg-white/95 backdrop-blur border-t border-orange-100 p-3 shadow-[0_-4px_20px_rgba(0,0,0,0.08)]" style={{ paddingBottom: "max(0.75rem, env(safe-area-inset-bottom))" }}>
          <a
            href="#categories"
